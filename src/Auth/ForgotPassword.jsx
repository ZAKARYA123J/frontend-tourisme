    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 to-purple-600 px-4">
      <div className="bg-white shadow-2xl rounded-2xl p-10 w-full max-w-md transform transition-all duration-700 hover:scale-105">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button type="submit" className="w-full py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-500 shadow-md">Send Reset Link</button>
        ...
        <div className="text-center mt-3">
          <Link to="/login" className="text-blue-600 hover:text-blue-800 transition-all duration-500">Back to Login</Link>
        </div>
      </div>
    </div>
  );
