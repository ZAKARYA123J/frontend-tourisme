...
const Marathons = () => {
    const [marathons, setMarathons] = useState([
        ...
        },
        {
            ...
            price: 'Registration starts at 200 MAD', 
            image: intermarath,
            isFavorite: false,
        },
        {
    ...
    const toggleFavorite = (id) => {
        setMarathons(marathons.map((marathon) => 
            marathon.id === id ? { ...marathon, isFavorite: !marathon.isFavorite } : marathon
        ));
    };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {marathons.map((marathon) => (
                    <div key={marathon.id} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
                        <img src={marathon.image} alt={marathon.name} className="w-full h-48 md:h-64 object-cover rounded-t-lg" />
                        <h3 className="text-xl font-semibold mt-4">{marathon.name}</h3>
